...
Now it's time for you to create your first website! Open your text editor and create a new file. In your text editor (e.g. [Atom](https://atom.io)), click the `File` menu and then click `New File`.
